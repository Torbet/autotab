...
tokens = [
    (1, 'one'), (1,'one'),      (2, 'one'), (2,'one'),
    (3, 'two'),     (4,'two'),      (5,'two'), (5, 'two'),      (6,'two'),(6,'two'),(6,'two'),     
    (7, 'three'), (7, 'three'),     (8,'three'),      (9,'three'), (9, 'three'),      (10,'three'),(10,'three'),(10,'three'),      (11,'three'),(11,'three'),
    (12, 'four'), (12,'four'),      (13, 'four')
    ]
...
start_bar = 0
for end_bar in segment_indexes:
    segment_tokens = [token for bar in range(start_bar, end_bar + 1)
                      for token in bar_dict.get(bar, [])]
    token_segments.append(segment_tokens)
    start_bar = end_bar + 1
